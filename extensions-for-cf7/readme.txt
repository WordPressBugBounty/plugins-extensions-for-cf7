...
= Version: 3.3.2 - Date: 20 Aug 2025 =
* Fixed: Issue with signature field required validation.

= Version: 3.3.1 - Date: 28 Jul 2025 =
* Fixed: Issue with range slider default value display if value is set to 0.
...
* Fixed: File name sanitize issue for entry delete action.
...
= Version: 3.2.4 - Date: 13 Mar 2025 =
* Fixed: Issue with form title not showing properly on submissions page.

= Version: 3.2.3 - Date: 27 Feb 2025 =
* Added: Support for Tag Generator v2.

= Version: 3.2.2 - Date: 05 Feb 2025 =
* Added: Support for Export and Import of Excel files.

= Version: 3.2.1 - Date: 13 Jan 2025 =
* Enhancement: Improved security for remote requests.

= Version: 3.2.0 - Date: 25 Nov 2024 =
* Fixed: Range slider default value issue for double handle type.
