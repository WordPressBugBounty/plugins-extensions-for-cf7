...
<?php
$info_data = \Cf7_Extensions\Admin\Dashboard_Widget_Api::get_remote_data();
        ...
        <ul>
            <li>
                <a href="https://hasthemes.com/blog/" target="_blank">
                    <?php esc_html_e( 'Blog', 'cf7-extensions' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/docs/cf7-extensions/" target="_blank">
                    <?php esc_html_e( 'Documentation', 'cf7-extensions' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/contact-us/" target="_blank">
                    <?php esc_html_e( 'Support', 'cf7-extensions' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
        </ul>
